package com.tiket.api.app.busandshuttle;
...
public class BusAndShuttle2Api implements BaseApi {
    ...
    public BusAndShuttle2Api(String accessToken, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        ...
        System.out.println("\n=== Bus and Shuttle 2 API Response ===");
