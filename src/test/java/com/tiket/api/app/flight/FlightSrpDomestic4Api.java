...
public class FlightSrpDomestic4Api implements BaseApi {
    ...
    public ApiResult hitApi() throws Exception {
        ...
        String query = "?cabinClass=ECONOMY&fullRefundReschedule=false&searchType=ONE_WAY&origin=JKTC&dcVar=true&destination=DPSC&infant=0&originType=CITY&async=true&enableVI=true&destinationType=CITY&flexiFare=true&departureDate=2026-02-09&adult=1&resultType=DEPARTURE&child=0";
