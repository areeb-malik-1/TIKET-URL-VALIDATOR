package com.tiket.api.app.airporttransfer;
...
public class AirportTransfer2Api implements BaseApi {
    ...
    public AirportTransfer2Api(String accessToken, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        String endpoint = "/ms-gateway/tix-airport-transfer-catalogue/v1/search-config";
        ...
        System.out.println("\n=== Airport Transfer 2 API Response ===");
