...
public class TodoPdp1Api implements BaseApi {
    ...
    public TodoPdp1Api(String accessToken, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        String endpoint = "/ms-gateway/tix-review-core/verticalReview/image-with-comments" +
                "?productType=TODO&page=0&size=20&lang=en&inventoryId=60794832fdf6074422b397b4";
