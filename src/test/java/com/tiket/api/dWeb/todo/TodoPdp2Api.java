...
public class TodoPdp2Api implements BaseApi {
    ...
    public TodoPdp2Api(String accessToken, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        String endpoint = "/ms-gateway/tix-events-v2-inventory/v1/productNotices/products/60794832fdf6074422b397b4";
