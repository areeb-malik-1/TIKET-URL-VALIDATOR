...
public class Tour2Api implements BaseApi {
    ...
    public Tour2Api(String accessToken, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        String endpoint = "/ms-gateway/tix-events-v2-inventory/v1/productSubcategories?productCategoryCode=TOUR";
