...
public class Tour4Api implements BaseApi {
    ...
    public ApiResult hitApi() throws Exception {
        String endpoint = "/ms-gateway/tix-events-v2-search/v3/product-cards?pageSize=12&productAllCategoryCodes=TOUR&sortDirection=DESC&sortField=popularityScore&ff-ttde-popularity-score-automation=true&ff-ttde-enter-search-improvement=true";
