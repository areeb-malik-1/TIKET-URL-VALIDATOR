package com.tiket.api.carrental;
...
public class CarRental2Api implements BaseApi {
    ...
    public CarRental2Api(String accessToken, String platform, String baseUrl) {
