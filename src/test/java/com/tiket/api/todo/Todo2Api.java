...
public class Todo2Api implements BaseApi {
    ...
    public Todo2Api(String accessToken, String platform, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("x-correlation-id", "f9df70e3-688b-4228-bf5a-3ca93420692a|1767875525507")
