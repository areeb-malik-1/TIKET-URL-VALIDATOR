...
public class TrainAndWooshPageModule2Api implements BaseApi {
    ...
    public TrainAndWooshPageModule2Api(String accessToken, String platform, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("x-correlation-id", "c5f0154e-aa0b-481a-a5c7-ad9d5b3cc3ca|1767871830921")
        ...
        System.out.println("\n=== Train and Woosh Page Module 2 API Response ===");
