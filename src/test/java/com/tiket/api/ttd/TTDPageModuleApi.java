...
public class TTDPageModuleApi implements BaseApi {
    ...
    public TTDPageModuleApi(String accessToken, String platform, String baseUrl) {
    ...
    public ApiResult hitApi() throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("containername", "com.tiket.android.ttd.presentation.homev3.HomeActivity")
                .header("screenname", "com.tiket.android.ttd.presentation.homev3.fragment.HomeFragment")
                .header("x-correlation-id", "c5f0154e-aa0b-481a-a5c7-ad9d5b3cc3ca|1767872260923")
                ...
                .header("if-modified-since", "Thu, 08 Jan 2026 10:30:52 GMT")
                .GET()
                .build();

        HttpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());

        System.out.println("\n=== TTD Page Module API Response ===");
