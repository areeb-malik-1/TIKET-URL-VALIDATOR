...
public class TestFlightSrpInternational4 extends BaseTest {
    ...
    public void testFlightSrpInternational4Url(VerifyUrls.UrlItem urlItem) {
    ...
    public void testFlightSrpInternational4Endpoint(VerifyUrls.EndpointItem endpointItem) {
