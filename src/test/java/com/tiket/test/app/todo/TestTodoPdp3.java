...
import com.tiket.api.app.todo.TodoPdp3Api;
...
public class TestTodoPdp3 extends BaseTest {
    ...
    public void testTodoPdp3Url(VerifyUrls.UrlItem urlItem) {
    ...
    public void testTodoPdp3Endpoint(VerifyUrls.EndpointItem endpointItem) {
