...
public class TestTodoPdp5 extends BaseTest {
    ...
    public void beforeClass() throws Exception {
        TodoPdp5Api api = new TodoPdp5Api(accessToken, baseUrl);
    ...
    public void testTodoPdp5Url(VerifyUrls.UrlItem urlItem) {
    ...
    public void testTodoPdp5Endpoint(VerifyUrls.EndpointItem endpointItem) {
