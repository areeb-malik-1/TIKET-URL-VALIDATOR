...
public class TestCarRental2 extends BaseTest {
    ...
    ApiResult apiResult;
    String[] urlKeys = Mapping.mapping.get(TestCarRental2.class.getName()).urls();
    String[] endpointKeys = Mapping.mapping.get(TestCarRental2.class.getName()).endpoints();

    @BeforeClass
    public void beforeClass() throws Exception {
        CarRental2Api carRental2Api = new CarRental2Api(accessToken, "ANDROID", baseUrl);
