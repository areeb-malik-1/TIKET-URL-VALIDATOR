...
import com.tiket.api.trainandwoosh.TrainAndWooshPageModule2Api;
...
public class TestTrainAndWooshPageModule2 extends BaseTest {
    ...
    ApiResult apiResult;
    String[] urlKeys = Mapping.mapping.get(TestTrainAndWooshPageModule2.class.getName()).urls();
    String[] endpointKeys = Mapping.mapping.get(TestTrainAndWooshPageModule2.class.getName()).endpoints();

    @BeforeClass
    public void beforeClass() throws Exception {
        TrainAndWooshPageModule2Api trainAndWooshPageModule2Api = new TrainAndWooshPageModule2Api(accessToken, "ANDROID", baseUrl);
