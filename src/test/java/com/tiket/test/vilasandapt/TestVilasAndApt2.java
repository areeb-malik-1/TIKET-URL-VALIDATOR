...
public class TestVilasAndApt2 extends BaseTest {
    ...
    ApiResult apiResult;
    String[] urlKeys = Mapping.mapping.get(TestVilasAndApt2.class.getName()).urls();
    String[] endpointKeys = Mapping.mapping.get(TestVilasAndApt2.class.getName()).endpoints();
