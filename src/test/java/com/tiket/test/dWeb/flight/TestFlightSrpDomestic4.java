...
public class TestFlightSrpDomestic4 extends BaseTest {
    ...
    public void beforeClass() throws Exception {
        ...
        FlightSrpDomestic4Api api2 = new FlightSrpDomestic4Api(accessToken, baseUrl, "CGK", "DPS", date);
        FlightSrpDomestic4Api api3 = new FlightSrpDomestic4Api(accessToken, baseUrl, "CGK", "PDG", date);
        FlightSrpDomestic4Api api4 = new FlightSrpDomestic4Api(accessToken, baseUrl, "CGK", "PGK", date);
        FlightSrpDomestic4Api api5 = new FlightSrpDomestic4Api(accessToken, baseUrl, "CGK", "PKU", date);
        FlightSrpDomestic4Api api6 = new FlightSrpDomestic4Api(accessToken, baseUrl, "CGK", "SUB", date);
        FlightSrpDomestic4Api api7 = new FlightSrpDomestic4Api(accessToken, baseUrl, "DTB", "CGK", date);
        FlightSrpDomestic4Api api8 = new FlightSrpDomestic4Api(accessToken, baseUrl, "CGK", "PNK", date);
