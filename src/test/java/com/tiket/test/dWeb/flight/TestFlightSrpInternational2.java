...
public class TestFlightSrpInternational2 extends BaseTest {
    ...
    public void testFlightSrpInternational2Url(VerifyUrls.UrlItem urlItem) throws Exception {
    ...
    public void testFlightSrpInternational2Endpoint(VerifyUrls.EndpointItem endpointItem) throws Exception {
