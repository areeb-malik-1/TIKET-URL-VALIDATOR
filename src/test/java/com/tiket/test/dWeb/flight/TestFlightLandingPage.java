...
import com.tiket.api.dWeb.flight.FlightLandingPageApi;
...
public class TestFlightLandingPage extends BaseTest {
    ...
    public void beforeClass() throws Exception {
        FlightLandingPageApi api = new FlightLandingPageApi(accessToken, baseUrl);
