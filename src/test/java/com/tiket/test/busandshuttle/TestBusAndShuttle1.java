...
import com.tiket.api.busandshuttle.BusAndShuttle1Api;
...
public class TestBusAndShuttle1 extends BaseTest {
    ...
    ApiResult apiResult;
    String[] urlKeys = Mapping.mapping.get(TestBusAndShuttle1.class.getName()).urls();
    String[] endpointKeys = Mapping.mapping.get(TestBusAndShuttle1.class.getName()).endpoints();

    @BeforeClass
    public void beforeClass() throws Exception {
        BusAndShuttle1Api busAndShuttle1Api = new BusAndShuttle1Api(accessToken, "ANDROID", baseUrl);
